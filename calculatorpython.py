...
value=""
data=StringVar()
screen=Entry(root,textvariable=data,bd=20,justify="right",bg="powder blue",font=("Ariel ",20))
...
btnc=Button(root,text="c",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=btnCler)
